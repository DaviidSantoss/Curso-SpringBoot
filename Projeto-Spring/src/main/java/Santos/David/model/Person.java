...
/* Classe que contém os "dados" de Person. a notação "@Entity"
* é a que faz o mapeamento da classe atual para o banco de dados,
* o "@Table (name = "person")" faz com que possamos setar o nome
