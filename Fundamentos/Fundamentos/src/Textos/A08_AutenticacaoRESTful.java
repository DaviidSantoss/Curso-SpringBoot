...
public class A08_AutenticacaoRESTful {
	...
	/*
	 * Normalmente enviamos uma requisição contendo os dados do usuário Email e Senha para api a qual
	 * queros utilizar, e essa requisição é do tipo POST com as informações no body, essa requisição
	 ...
	 * autorizada.
	 * 
	 * Porém é inseguro ficar mandando as informações do cliente toda vez que uma requisição for feita
